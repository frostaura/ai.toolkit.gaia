...
public interface ITaskPlannerManager
{
    ...
    Task<string> AddNewTaskToPlanAsync(string planId, string title, string description, string acceptanceCriteria, string owner, string tags, string groups, string? parentTaskId, double estimateHours);
